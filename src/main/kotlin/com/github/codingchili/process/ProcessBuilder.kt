 ...
 */
interface ProcessBuilder<C : ProcessContext, E : Serializable> {

    /**
     * @param processName the name of the process.
     * @return fluent
     */
    fun setName(processName: String): ProcessBuilder<C, E>
     ...
     * @return fluent
     */
    fun vertex(plugin: Class<out ProcessPlugin<C, E>>): ProcessBuilder<C, E>
     ...
     * @return fluent
     */
    fun edge(to: Class<out ProcessPlugin<C, E>>): ProcessBuilder<C, E>

    /**
     * @param item
     * @return future completed when the job is done (for streaming jobs they are never done.)
     */
    fun submit(item: E): CompletableFuture<Void>
